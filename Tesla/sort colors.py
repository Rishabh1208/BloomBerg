...
# Initially we group all elements into unclassified. We iterate from the beginning as long 
...
# both white and red pointer forward. If the pointer is white (nums[white] == 1), 
